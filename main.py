...
class StartPage(tk.Frame):
       ...
       def __init__(self, parent, controller):
              ...
              label = tk.Label(self, text="TALK", font=("Verdana", 20))
...
class VtoS(tk.Frame):
       def __init__(self, parent, controller):
              ...
              inputtxt=None
              tk.Frame.__init__(self, parent)
              label = tk.Label(self, text="Voice to Sign", font=("Verdana", 20))
              label.pack(pady=10,padx=10)
